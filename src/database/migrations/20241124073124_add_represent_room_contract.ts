...
export async function up(knex: Knex): Promise<void> {
    return knex.schema
        ...
        ON room_contracts
        FOR EACH ROW
        INSERT INTO room_contract_history (room_contract_id, room_id, landlord, renter, renter_ids, contract_id, deposit_amount, deposit_status, deposit_date, deposit_refund, deposit_refund_date, rental_start_date, rental_end_date, room, services, equipment, status, action, created_by, created_at, updated_by, updated_at)
