...
export async function up(knex: Knex): Promise<void> {
    return knex.raw(`
        ...
        VALUES (NEW.id, NEW.house_id, NEW.name, NEW.account_number, NEW.status, NEW.description, NEW.payos_client_id, NEW.payos_api_key, NEW.payos_checksum, "UPDATE", @created_by);`);
}
