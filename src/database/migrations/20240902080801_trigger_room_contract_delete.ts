...
export async function up(knex: Knex): Promise<void> {
    return knex.raw(`
        ...
        VALUES (OLD.id, OLD.room_id, OLD.contract_id, OLD.deposit_amount, OLD.deposit_status, OLD.deposit_date, OLD.deposit_refund, OLD.deposit_refund_date, OLD.rental_start_date, OLD.rental_end_date, OLD.status, "DELETE", @created_by);`);
}
