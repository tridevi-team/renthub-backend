...
renterRouter.get("/rooms/:roomId/list", authentication, authorize(Module.RENTER, Action.READ), roomsValidator.roomId, handleErrors, RenterController.getRentersByRoom);
renterRouter.get("/houses/:houseId/list", authentication, authorize(Module.RENTER, Action.READ), houseValidator.houseIdValidator, handleErrors, RenterController.getRentersByHouse);
...
renterRouter.patch("/:renterId/change-represent", authentication, authorize(Module.RENTER, Action.UPDATE), renterValidator.renterId, handleErrors, RenterController.changeRepresent);
